...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        AlgorithmInterface algorithm = exampleInit3(lineChart, xAxis, yAxis, recordHolder);
    ...
    public AlgorithmInterface exampleInit1(LineChart<Number, Number> lineChart, NumberAxis xAxis, NumberAxis yAxis, RecordHolder recordHolder)
    {
        ...
        AlgorithmInterface algorithm = algorithmFactory.createAlgorithm(AlgorithmEnum.EULER, 0, 1);
        recordHolder.createSeries(algorithm, h, 0.001, 4.0, step);
        return algorithm;
    }

    public AlgorithmInterface exampleInit2(LineChart<Number, Number> lineChart, NumberAxis xAxis, NumberAxis yAxis, RecordHolder recordHolder)
    {
        init(lineChart, xAxis, yAxis);
        xAxis.setLowerBound(0.0);
        ...
        yAxis.setLowerBound(0.0);
        AlgorithmFactory algorithmFactory = new AlgorithmFactory();
        AlgorithmInterface algorithm = algorithmFactory.createAlgorithm(AlgorithmEnum.EULER, 0, 3);
        recordHolder.createSeries(algorithm, h, 0.001, 2.0, step);
        return algorithm;
    }

    public AlgorithmInterface exampleInit3(LineChart<Number, Number> lineChart, NumberAxis xAxis, NumberAxis yAxis, RecordHolder recordHolder)
    {
        init(lineChart, xAxis, yAxis);
        xAxis.setLowerBound(0.0);
        xAxis.setUpperBound(2.0);
        ...
        yAxis.setLowerBound(0.0);
        AlgorithmFactory algorithmFactory = new AlgorithmFactory();
        AlgorithmInterface algorithm = algorithmFactory.createAlgorithm(AlgorithmEnum.EULER, 0, 2);
        recordHolder.createSeries(algorithm, h, 0.001, 2.0, step);
        return algorithm;
    }
